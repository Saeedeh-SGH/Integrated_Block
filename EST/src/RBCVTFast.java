...
public class RBCVTFast {//Random border CVT
    ...
    public ArrayDouble2D getBorderPoints(ArrayDouble2D dataGenerator){//uniform random
    ...
    public void CVT_Iterate(ArrayDouble2D data, ERandom rand, int sample_size, ArrayDouble2D borderPoints){
        ...
        SpacialSearch2 ss=new SpacialSearch2();
